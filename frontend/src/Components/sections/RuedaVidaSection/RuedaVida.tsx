...
const RuedaVida: React.FC<RuedaVidaProps> = ({
  ...
  return (
    <section
      id="ruedavida"
      className="relative w-full bg-linen pt-10 md:pt-12 pb-14 md:pb-18"
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Panel editorial (imagen + CTA enriquecido) */}
        <div className="relative mx-auto max-w-5xl rounded-2xl bg-white/90 p-5 md:p-7 ring-1 ring-black/5 supports-[backdrop-filter]:backdrop-blur-md shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-6 md:gap-8 items-center">
            ...
            <figure className="relative">
              ...
              <div aria-hidden className="absolute -bottom-2 -right-1 md:-right-3 translate-x-1/4 md:translate-x-0">
        ...
        {/* Chips de áreas */}
        <nav aria-label="Explora otras áreas" className="mt-8 md:mt-10">
          <SectionHeader
            ...
            color="asparragus"
            className="mb-4"
            decoration={<span className="mx-auto block h-[2px] w-14 rounded-full bg-gold/60" />}
          />
          <ul
            role="list"
