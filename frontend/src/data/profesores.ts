import { Profesor } from "./types";
   ...
   export const profesores: Profesor[] = [
  {
    ...
    description: "Soy Patricia, especialista en acompañamiento emocional y crecimiento personal. Con más de 10 años de experiencia, te guío en procesos de autoconocimiento y sanación interior utilizando herramientas como la psicología transpersonal, constelaciones familiares y mindfulness.",
    specialties: ["Crecimiento personal", "Sanación emocional", "Mindfulness"],
    image: "/img/Team/Paty.png",
...

  {
    id: 5,
    name: "Marina Romes",
    title: "Terapeuta energética especializada en Registros Akáshicos",
    description: "Hola, soy Marina, terapeuta energética especializada en Registros Akáshicos. Mi pasión es acompañarte a liberar tus miedos y bloqueos para que te sientas en plenitud y expansión. Mis temas favoritos para desbloquear y sanar: las relaciones (familia/parejas), autoestima y dinero.",
    specialties: ["Registros Akáshicos", "Limpieza energética", "Vidas pasadas"],
    image: "/img/Team/MarinaRomes.png",
